...
import { SparkleIcon, SquareIcon, ImageIcon, PenToolIcon, CpuIcon, ChevronDown, ChevronDownIcon } from "lucide-react";
    ...
    return (
        <div className="relative space-y-3 dark">
            ...
            >
                ...
                <ChevronDownIcon
                    className={['h-5 w-5 text-zinc-400 transition-transform', isOpen && 'rotate-180'].join(' ')}
                />
            </button>
            {/* DROPDOWN MENU */}
            {isOpen && (
