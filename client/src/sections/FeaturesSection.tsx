...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why use our generator?" text3="Create thumbnails that can get you clicks without much hassle" />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Our ai understands the core elements that make a thumbnail effective, including color schemes, typography, imagery, and composition. By analyzing these factors, it generates thumbnails that are not only visually appealing but also optimized for higher click-through rates.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Boost your view by AI-optimised designs </h3>
