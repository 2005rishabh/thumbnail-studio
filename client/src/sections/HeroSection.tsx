    ...
    return (
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <motion.a
                ...
                className="group flex items-center gap-2 rounded-full p-1 pr-3 mt-44 text-pink-100 bg-pink-200/15 cursor-pointer"
            ...
            >
                Turn simple ideas into high-impact {" "}
                <span className="move-gradient px-3 rounded-xl text-nowrap"> thumbnails.</span>
            </motion.h1>
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Stop wasting hours in design. Get your high quality thumbnails generated in seconds. </motion.p>
